...
const rightButtonSectionOne = document.getElementById(
  'right_button_section_one'
);
const leftButtonSectionOne = document.getElementById('left_button_section_one');

const scrollHorizontalGrid = document.getElementById(
  'trending_products_grid_scroll'
);
